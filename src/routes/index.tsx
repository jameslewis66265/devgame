...
function PaylockStatus({ status }: { status: string }) {
 ...
 : "bg-muted-foreground";
 return (
 <div className="fixed bottom-4 right-4 z-50 flex items-center gap-2 border border-border bg-card/80 px-3 py-1.5 text-xs text-muted-foreground shadow-card backdrop-blur">
...
function Nav() {
 ...
 <div className="grid h-8 w-8 place-items-center bg-gradient-primary shadow-glow">
 ...
 <a
 href="#cta"
 className="inline-flex items-center gap-1.5 bg-gradient-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-transform hover:scale-105"
 >
...
function Hero() {
 ...
 <span className="inline-flex items-center gap-2 border border-border bg-card/60 px-3 py-1 text-xs text-muted-foreground backdrop-blur">
 ...
 <a
 href="#cta"
 className="inline-flex items-center gap-2 bg-gradient-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-glow transition-transform hover:scale-105"
 >
 Start free trial <ArrowRight className="h-4 w-4" />
 </a>
 <a
 href="#how"
 className="inline-flex items-center gap-2 border border-border bg-card/60 px-6 py-3 text-sm font-medium text-foreground backdrop-blur hover:bg-card"
 >
 See how it works
 </a>
 </div>
...
function HeroPreview() {
 ...
 <span className="h-2.5 w-2.5 bg-primary/70" />
...
function Features() {
 ...
 <div
 key={f.title}
 className="group border border-border bg-card p-6 transition-all hover:-translate-y-1 hover:border-primary/50 hover:shadow-glow"
 >
 <div className="grid h-10 w-10 place-items-center bg-gradient-primary text-primary-foreground">
...
function HowItWorks() {
 ...
 {steps.map((s) => (
 <div key={s.n} className="relative border border-border bg-background p-8">
...
function Pricing() {
 ...
 <span className="h-1.5 w-1.5 bg-primary" /> {f}
 </li>
 ))}
 </ul>
 <a
 href="#cta"
 className={`mt-8 inline-flex w-full items-center justify-center px-4 py-2.5 text-sm font-semibold transition-transform hover:scale-[1.02] ${
 t.featured
...
function CTA() {
 ...
 <div className="relative overflow-hidden border border-border bg-card p-12 text-center shadow-card">
 ...
 className="flex-1 border border-border bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
 />
 <button
 type="submit"
...
function Footer() {
 ...
 <div className="grid h-6 w-6 place-items-center bg-gradient-primary">
